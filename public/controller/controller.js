...
$scope.getDetails=function(){
     ...
     var arrlength =response.length ;
        ...
        // 
         ...
         //mrp  disable call
        //  for (let z = 0; z <= $scope.userit.length; z++){
        //  console.log($scope.userit[z].mrp)
        //  // if($scope.userit[z].mrp== undefined ||$scope.userit[z].mrp== null){
        //  // alert("in getdetails "+response.length)
        //  //  continue;
        //  // } 
        // if($scope.userit[z].mrp != undefined){
...
$scope.addDis=function()
{
    ...
    // alert("$scope.saleinv[0].taxableval "+$scope.saleinv[0].taxableval)
    //  alert("$scope.saleinv[0].tax "+$scope.saleinv[0].tax)
    //   alert("$scope.saleinv[0].labourtax "+$scope.saleinv[0].labourtax)
    //    alert(" parseFloat( $scope.saleinv[0].labourValue "+ $scope.saleinv[0].labourValue )
